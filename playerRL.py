#################################################################################################################
# THIS FILE IS FOR RUNNING THE PLAYER AGENT. THE PLATFORMS ARE GENERATED RANDOMLY EVERY LEVEL IN THIS GAME LOOP.
...
while run:
    ...
    if game_over == False:
        ...
        #print(player_state)
        #print(np.array(player_state).reshape(3,4))
        ...
        reward = reward_player(score,prev_score,game_end_state)
        prev_score = score
        ...
        #agentPlayer.update_replay_memory((player_state,action,reward,player_state_next,True))
        #TRAINING
        step+=1
