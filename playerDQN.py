######################################################################################################
# THIS FILE DEFINES THE DQN MODEL FOR THE PLAYER AGENT. IT IS IMPORTED IN THE GAME FILES.
######################################################################################################
...
class DQNAgent():
    ...
    def create_model(self):
        ...
        model.add(Conv2D(512,(3,3),input_shape = (50,50,1)))
    ...
    def get_qs(self, state):
        return self.model.predict(np.array(state).reshape(-1,*np.array(state).shape)/255,verbose=0)[0]
